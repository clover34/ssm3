    ...
    <script>
        $(function(){
            ...
            function sumbitData(){
                ...
                $.ajax({
                    url:"<%=request.getContextPath()%>/back/scenicspot/add",
                    type:"post",
                    data:formData,
                    dataType:"json",
        ...
        <div class="col-md-4 column col-md-offset-4">
            <form role="form" id="add">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ssName" id="ssName" placeholder="景点名称"/>
                </div>
<%--                    省份信息--%>
                <div class="form-group">
                ...
                <div class="form-group text-center">
                    ...
                    <img id="showImage"  src="<%=request.getContextPath()%>/upload/1.jpg" class="img-rounded"  style="height: 60px;width: 290px;cursor: pointer">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ssAddress" id="ssAddress" placeholder="详细地址"/>
                </div>
                <%--                开放时间--%>
                <div class="form-group">
